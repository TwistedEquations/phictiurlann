...
class PngquantTest {
  ...
  @Test
  fun canPalettise() {
    val pngPaletise = Pngquant(project)
    ...
    PngquantTest::class.java.getResourceAsStream("/images/pngquant/pngpalettise_canpalettise.png").copyTo(outStream1)
    outStream1.close()
  ...
  fun cantPalettise() {
    ...
    PngquantTest::class.java.getResourceAsStream("/images/pngquant/pngpalettise_cantpalettise.png").copyTo(outStream1)
    outStream1.close()
  ...
  fun palettiseImage() {
    ...
    PngquantTest::class.java.getResourceAsStream("/images/pngquant/pngpalettise_canpalettise.png").copyTo(outStream)
    outStream.close()

    val result = pngQuant.convert(ConvertRequest(imageInputFile, imageOutputFile))
